                    ...
                    <div class="item-container">
                        <div class="container text-center">
                            <div class="row mt-3">
                                ...
                                <div
                                    class="col-4"> {{ $owner = $car->owner_name == NULL ? 'Нет владельца' : $car->owner_name }} </div>
                                <div class="col-2">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                ...
                                @else
                                    ...
                                    @if($pageNumber <= 9 )
                                        @for($i = 1; $i <=10; $i++)
                                            <li class="page-item @if($i == $pageNumber) active @endif"><a
                                                    class="page-link" href="/car-list?page= {{ $i }}">{{ $i }}</a></li>
                                        @endfor
                                    @endif
                                    ...
                                    @if($pageNumber > 9 && $pageNumber <= $pageCount-9)
                                        ...
                                        <li class="page-item"><a class="page-link" href="#"> ... </a></li>
                                        <li class="page-item @if($pageNumber == $pageCount) active @endif"><a
                                                class="page-link"
                                                href="/car-list?page= {{ $pageCount }}">{{ $pageCount }}</a></li>
                                    @endif
                                ...
                                <li class="page-item @if($pageNumber == $pageCount) disabled @endif"><a
                                        class="page-link" href="/car-list?page={{$pageNumber+1}}">Next</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
